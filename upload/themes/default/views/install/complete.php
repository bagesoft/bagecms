...
<div class="mainbody">
  <div class="complete">
    <div class="complete_txt">
      ...
      <strong>现在您可以：</strong> <a href="<?php echo Yii::app()->homeUrl?>">访问网站首页</a><span>或</span><a href="<?php echo $this->createUrl(
						'/admini')?>">登陆后台</a>
      <div class="complete_note"> 

      <p >如需重新安装，请先删除 data/install.lock 文件</p>
      <p class="red">为了安全起见，请删除本安装程序控制器 protected/controllers/InstallController.php <input name="submit" type="button" value=" 删除本安装程序 " id="rminstall"/></p>
